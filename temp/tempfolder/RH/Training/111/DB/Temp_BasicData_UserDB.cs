...
namespace RH.Training.DB
{
    ...
    public class Temp_BasicData_UserDB
    {
        ...
        public static int AddTemp_BasicData_User(Temp_BasicData_UserEntity info)
        {
            ...
            DBLib.ExecuteSP("dbo.SJ_RH_Temp_BasicData_User_Add", param, DBConnEnm.TRDBWrite);
        ...
        public static int ModifyTemp_BasicData_User(Temp_BasicData_UserEntity info)
        {
            ParamCollection param = new ParamCollection();
            param.Add("@XML", SerializeLib.Class2XML(info));
            DBLib.ExecuteSP("dbo.SJ_RH_Temp_BasicData_User_Modify", param, DBConnEnm.TRDBWrite);
            return int.Parse(param.ParamOutput.ToString());
        }
        ...
        public static int RemoveTemp_BasicData_User(int ID)
        {
            ...
            param.Add("@ID", ID);
            param.AddByOutput("@Result", SqlDbType.Int);
            DBLib.ExecuteSP("dbo.SJ_RH_Temp_BasicData_User_Remove", param, DBConnEnm.TRDBWrite);
            return int.Parse(param.ParamOutput.ToString());
        ...
        public static Temp_BasicData_UserEntity GetTemp_BasicData_UserDetail(int ID)
        {
            ParamCollection param = new ParamCollection();
            param.Add("@ID", ID);
            DataTable dt = DBLib.GetDataTableBySP("dbo.SJ_RH_Temp_BasicData_User_Detail", param, DBConnEnm.TRDBWrite);
            return (Temp_BasicData_UserEntity)ORMapping.MapSingleObject(typeof(Temp_BasicData_UserEntity),dt);
        }
    }
}