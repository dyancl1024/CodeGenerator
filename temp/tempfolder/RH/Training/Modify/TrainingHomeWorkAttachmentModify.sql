/*
  RH_TrainingHomeWorkAttachment - 修改信息脚本
*/
DROP PROCEDURE IF EXISTS sp_SJ_RH_TrainingHomeWorkAttachment_Modify;
CREATE  PROCEDURE sp_SJ_RH_TrainingHomeWorkAttachment_Modify
(
   IN i_ID int,
   IN i_HomeWorkID int,
...
BEGIN
  ...
  UPDATE RH_TrainingHomeWorkAttachment
  SET
