...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  ...
  <xsl:variable name="pageTypeStrName" select="'DB'" />
  ...
  <xsl:template match="table">
    ...
    <xsl:text disable-output-escaping="yes">using System.Data;&#xD;&#xA;</xsl:text>
    <xsl:text disable-output-escaping="yes">using System.Linq;&#xD;&#xA;</xsl:text>
    <xsl:text disable-output-escaping="yes">using RH.Sql;&#xD;&#xA;</xsl:text>
  ...
  <xsl:template name="printDefaultMethods_Insert">
    ...
    <xsl:text disable-output-escaping="yes">)&#xD;&#xA;        {&#xD;&#xA;</xsl:text>
    <xsl:text disable-output-escaping="yes">            MySqlParamCollection param = new MySqlParamCollection();&#xD;&#xA;&#xD;&#xA;</xsl:text>
    <xsl:for-each select="$properties">
      <xsl:sort select="@PK"/>
      <xsl:if test="position()&lt;last()">
        <xsl:text disable-output-escaping="yes">            param.Add("@i_</xsl:text>
    ...
    <xsl:text disable-output-escaping="yes">            param.AddByOutput("@o_Result", MySqlDbType.Int32);&#xD;&#xA;</xsl:text>
    <xsl:text>            MySqlDBLib.ExecuteSP("</xsl:text>
    <xsl:value-of select="$SqlPrefix"/>
    <xsl:value-of select="@Code"/>
    <xsl:text disable-output-escaping="yes">_Add", param, DBConnEnm.TRDBWrite);&#xD;&#xA;&#xD;&#xA;</xsl:text>
    <xsl:text disable-output-escaping="yes">            return int.Parse(param.ParamOutput.ToString());&#xD;&#xA;</xsl:text>
    <xsl:text disable-output-escaping="yes">        }&#xD;&#xA;&#xD;&#xA;</xsl:text>
  </xsl:template>
  ...
  <xsl:template name="printDefaultMethods_Update">
    ...
    <xsl:value-of select="$SqlPrefix"/>
    <xsl:value-of select="@Code"/>
    <xsl:text disable-output-escaping="yes">_Modify", param, DBConnEnm.TRDBWrite);&#xD;&#xA;&#xD;&#xA;</xsl:text>
    <xsl:text disable-output-escaping="yes">            return int.Parse(param.ParamOutput.ToString());&#xD;&#xA;</xsl:text>
    <xsl:text disable-output-escaping="yes">        }&#xD;&#xA;&#xD;&#xA;</xsl:text>
  </xsl:template>
  ...
  <xsl:template name="printDefaultMethods_Delete">
    ...
    <xsl:text disable-output-escaping="yes">            param.AddByOutput("@Result", MySqlDbType.Int32);&#xD;&#xA;</xsl:text>
    <xsl:text>            MySqlDBLib.ExecuteSP("</xsl:text>
    <xsl:value-of select="$SqlPrefix"/>
    <xsl:value-of select="@Code"/>
    <xsl:text disable-output-escaping="yes">_Remove", param, DBConnEnm.TRDBWrite);&#xD;&#xA;&#xD;&#xA;</xsl:text>
    <xsl:text disable-output-escaping="yes">            return int.Parse(param.ParamOutput.ToString());&#xD;&#xA;</xsl:text>
  ...
  <xsl:template name="printDefaultMethods_View">
    ...
    <xsl:text>            DataTable dt = MySqlDBLib.GetDataTableBySP("</xsl:text>
    <xsl:value-of select="$SqlPrefix"/>
    <xsl:value-of select="@Code"/>
    <xsl:text disable-output-escaping="yes">_Detail", param, DBConnEnm.TRDBWrite);&#xD;&#xA;&#xD;&#xA;</xsl:text>
    <xsl:text>            return (</xsl:text>
    <xsl:value-of select="/tables/table/@ShowCode"/>
    <xsl:text>Info)ORMapping.MapSingleObject(typeof(</xsl:text>
    <xsl:value-of select="/tables/table/@ShowCode"/>
    <xsl:text disable-output-escaping="yes">Info),dt);&#xD;&#xA;</xsl:text>
    <xsl:text disable-output-escaping="yes">        }&#xD;&#xA;</xsl:text>
  </xsl:template>
  ...
  <xsl:template name="printDefaultMethods_List">
    ...
    <xsl:value-of select="/tables/table/@ShowCode"/>
    <xsl:value-of select="$pageTypeEntity"/>
    <xsl:text>ListResult Get</xsl:text>
    <xsl:value-of select="/tables/table/@ShowCode"/>
    <xsl:value-of select="$pageTypeEntity"/>
    <xsl:text>List(</xsl:text>
    <xsl:value-of select="/tables/table/@ShowCode"/>
    <xsl:text>Searcher Searcher)</xsl:text>
    <xsl:text disable-output-escaping="yes">&#xD;&#xA;        {&#xD;&#xA;</xsl:text>
    <xsl:text disable-output-escaping="yes">            MySqlParamCollection param = new MySqlParamCollection();&#xD;&#xA;&#xD;&#xA;</xsl:text>

    <xsl:text disable-output-escaping="yes">            param.Add("@i_PageSize",Searcher.PageSize);&#xD;&#xA;</xsl:text>
    <xsl:text disable-output-escaping="yes">            param.Add("@i_PageIndex",Searcher.PageIndex);&#xD;&#xA;</xsl:text>
    <xsl:text disable-output-escaping="yes">            param.AddByOutput("@o_TotlaCount", MySqlDbType.Int32);&#xD;&#xA;</xsl:text>

    <xsl:text>            DataTable dt = MySqlDBLib.GetDataSetBySP("</xsl:text>
    <xsl:value-of select="$SqlPrefix"/>
    <xsl:value-of select="@Code"/>
    <xsl:text disable-output-escaping="yes">_List", param, DBConnEnm.TRDBWrite);&#xD;&#xA;&#xD;&#xA;</xsl:text>
    <xsl:text >            </xsl:text>
    <xsl:value-of select="/tables/table/@ShowCode"/>
    <xsl:value-of select="$pageTypeEntity"/>
    <xsl:text>ListResult Result= new </xsl:text>
    <xsl:value-of select="/tables/table/@ShowCode"/>
    <xsl:value-of select="$pageTypeEntity"/>
    <xsl:text disable-output-escaping="yes">ListResult();&#xD;&#xA;</xsl:text>
    <xsl:text>            Result.</xsl:text>
    <xsl:value-of select="/tables/table/@ShowCode"/>
    <xsl:text disable-output-escaping="yes">List = (List&lt;</xsl:text>
    <xsl:value-of select="/tables/table/@ShowCode"/>
    <xsl:text>Info</xsl:text>
    <xsl:text disable-output-escaping="yes">&gt;)ORMapping.MapListObject(typeof(</xsl:text>
    <xsl:value-of select="/tables/table/@ShowCode"/>
    <xsl:text>Info</xsl:text>
    <xsl:text disable-output-escaping="yes">),dt);&#xD;&#xA;</xsl:text>
    <xsl:text disable-output-escaping="yes">            Result.TotalCount = int.Parse(param.ParamOutput.ToString());&#xD;&#xA;&#xD;&#xA;</xsl:text>
    <xsl:text disable-output-escaping="yes">            return Result;&#xD;&#xA;</xsl:text>
    <xsl:text disable-output-escaping="yes">        }&#xD;&#xA;</xsl:text>
  </xsl:template>
