...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  ...
  <xsl:template name="printDefaultMethods_Insert">
    ...
    <xsl:text disable-output-escaping="yes">)&#xD;&#xA;        {&#xD;&#xA;</xsl:text>
    <xsl:text disable-output-escaping="yes">            ParamCollection param = new ParamCollection();&#xD;&#xA;</xsl:text>
    <xsl:text disable-output-escaping="yes">            param.Add("@XML", SerializeLib.Class2XML(info));&#xD;&#xA;</xsl:text>
    <xsl:text disable-output-escaping="yes">            param.AddByOutput("@Result", SqlDbType.Int);&#xD;&#xA;</xsl:text>
    <xsl:text>            DBLib.ExecuteSP("dbo.SJ_</xsl:text>
  ...
  <xsl:template name="printDefaultMethods_Delete">
    ...
    <xsl:text disable-output-escaping="yes">&#xD;&#xA;        {&#xD;&#xA;</xsl:text>
    <xsl:text disable-output-escaping="yes">            ParamCollection param = new ParamCollection();&#xD;&#xA;</xsl:text>
    <xsl:text disable-output-escaping="yes">            param.Add("@ID", ID);&#xD;&#xA;</xsl:text>
    <xsl:text disable-output-escaping="yes">            param.AddByOutput("@Result", SqlDbType.Int);&#xD;&#xA;</xsl:text>
    <xsl:text>            DBLib.ExecuteSP("dbo.SJ_</xsl:text>
    <xsl:value-of select="@Code"/>
  ...
  <xsl:template name="printDefaultMethods_View">
    ...
    <xsl:text disable-output-escaping="yes">            ParamCollection param = new ParamCollection();&#xD;&#xA;</xsl:text>
    <xsl:text disable-output-escaping="yes">            param.Add("@ID", ID);&#xD;&#xA;</xsl:text>
    <xsl:text>            DataTable dt = DBLib.GetDataTableBySP("dbo.SJ_</xsl:text>
    <xsl:value-of select="@Code"/>
    <xsl:text disable-output-escaping="yes">_Detail", param, DBConnEnm.TRDBWrite);&#xD;&#xA;</xsl:text>
    <xsl:text>            return (</xsl:text>
    <xsl:value-of select="/tables/table/@ShowCode"/>
    <xsl:value-of select="$pageTypeEntity"/>
    <xsl:text>)ORMapping.MapSingleObject(typeof(</xsl:text>
    <xsl:value-of select="/tables/table/@ShowCode"/>
    <xsl:value-of select="$pageTypeEntity"/>
