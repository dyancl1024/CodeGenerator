/*
  RH_CourseAttachment - 修改信息脚本
*/
DROP PROCEDURE IF EXISTS sp_SJ_RH_CourseAttachment_Modify;
CREATE  PROCEDURE sp_SJ_RH_CourseAttachment_Modify
(
   IN i_ID int,
   IN i_CourseID int,
